<template>
    <main class="p-10">
      <form @submit.prevent="search">
        <div class="flex justify-center m-auto">
          <input v-model="searchTerm" type="text" placeholder="SEARCH" class="rounded-md lg:w-2/12 bg-gray-100 pl-4 ">
          <button @click="search" class="bg-blue-300 p-3 text-2xl rounded-md ml-4 text-white uppercase">Search</button>
        </div>
      </form>
    ...
    const imgTest = 'https://image.tmdb.org/t/p/w1280/ugZW8ocsrfgI95pnQ7wrmKDxIe.jpg';
    export default {
      data:()=> ({
        imgTest: imgTest,
        imgs: [],
